...
import type { CookieImportResult, NowPlaying, PlaybackState, TrackInfo, Y7skApi } from '@shared/types'
...
const api: Y7skApi = {
  ...
  importCookies: (json: string) =>
    ipcRenderer.invoke(IPC.AUTH_IMPORT_COOKIES, json) as Promise<CookieImportResult>,
